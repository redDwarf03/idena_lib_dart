...
ContractReadDataByteResponse contractReadDataByteResponseFromJson(String str) =>
    ContractReadDataByteResponse.fromJson(json.decode(str));
...
class ContractReadDataByteResponse {
  ...
  factory ContractReadDataByteResponse.fromJson(Map<String, dynamic> json) =>
      ContractReadDataByteResponse(
