...
ContractEstimateDeployRequest contractEstimateDeployRequestFromJson(
        String str) =>
    ContractEstimateDeployRequest.fromJson(json.decode(str));

String contractEstimateDeployRequestToJson(
        ContractEstimateDeployRequest data) =>
...
class ContractEstimateDeployRequest {
  ...
  factory ContractEstimateDeployRequest.fromJson(Map<String, dynamic> json) =>
      ContractEstimateDeployRequest(
        method: json["method"],
