...
ContractCallMultiSigRequest contractCallMultiSigRequestFromJson(String str) =>
    ContractCallMultiSigRequest.fromJson(json.decode(str));

String contractCallMultiSigRequestToJson(ContractCallMultiSigRequest data) =>
...
class ContractCallMultiSigRequest {
  ...
  factory ContractCallMultiSigRequest.fromJson(Map<String, dynamic> json) =>
      ContractCallMultiSigRequest(
        method: json["method"],
