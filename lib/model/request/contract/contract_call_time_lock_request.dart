...
ContractCallTimeLockRequest contractCallTimeLockRequestFromJson(String str) =>
    ContractCallTimeLockRequest.fromJson(json.decode(str));

String contractCallTimeLockRequestToJson(ContractCallTimeLockRequest data) =>
...
class ContractCallTimeLockRequest {
  ...
  factory ContractCallTimeLockRequest.fromJson(Map<String, dynamic> json) =>
      ContractCallTimeLockRequest(
        method: json["method"],
