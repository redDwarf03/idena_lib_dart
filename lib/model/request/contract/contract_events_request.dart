...
ContractEventsRequest contractEventsRequestFromJson(String str) =>
    ContractEventsRequest.fromJson(json.decode(str));

String contractEventsRequestToJson(ContractEventsRequest data) =>
...
class ContractEventsRequest {
  ...
  factory ContractEventsRequest.fromJson(Map<String, dynamic> json) =>
      ContractEventsRequest(
        method: json["method"],
