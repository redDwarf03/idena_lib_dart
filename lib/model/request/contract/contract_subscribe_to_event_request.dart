...
String contractSubscribeToEventRequestToJson(
        ContractSubscribeToEventRequest data) =>
...
class ContractSubscribeToEventRequest {
  ...
  factory ContractSubscribeToEventRequest.fromJson(Map<String, dynamic> json) =>
      ContractSubscribeToEventRequest(
        method: json["method"],
