...
ContractUnsubscribeFromEventRequest contractUnsubscribeFromEventRequestFromJson(
        String str) =>
    ContractUnsubscribeFromEventRequest.fromJson(json.decode(str));

String contractUnsubscribeFromEventRequestToJson(
        ContractUnsubscribeFromEventRequest data) =>
...
class ContractUnsubscribeFromEventRequest {
  ...
  factory ContractUnsubscribeFromEventRequest.fromJson(
