...
ContractEstimateCallRequest contractEstimateCallRequestFromJson(String str) =>
    ContractEstimateCallRequest.fromJson(json.decode(str));

String contractEstimateCallRequestToJson(ContractEstimateCallRequest data) =>
...
class ContractEstimateCallRequest {
  ...
  factory ContractEstimateCallRequest.fromJson(Map<String, dynamic> json) =>
      ContractEstimateCallRequest(
        method: json["method"],
