...
ContractGetStakeRequest contractGetStakeRequestFromJson(String str) =>
    ContractGetStakeRequest.fromJson(json.decode(str));

String contractGetStakeRequestToJson(ContractGetStakeRequest data) =>
...
class ContractGetStakeRequest {
  ...
  factory ContractGetStakeRequest.fromJson(Map<String, dynamic> json) =>
      ContractGetStakeRequest(
        method: json["method"],
