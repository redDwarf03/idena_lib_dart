...
ContractTerminateRequest contractTerminateRequestFromJson(String str) =>
    ContractTerminateRequest.fromJson(json.decode(str));

String contractTerminateRequestToJson(ContractTerminateRequest data) =>
...
class ContractTerminateRequest {
  ...
  factory ContractTerminateRequest.fromJson(Map<String, dynamic> json) =>
      ContractTerminateRequest(
        method: json["method"],
