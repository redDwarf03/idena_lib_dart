...
FlipShortHashesRequest flipShortHashesRequestFromJson(String str) =>
    FlipShortHashesRequest.fromJson(json.decode(str));

String flipShortHashesRequestToJson(FlipShortHashesRequest data) =>
...
class FlipShortHashesRequest {
  ...
  factory FlipShortHashesRequest.fromJson(Map<String, dynamic> json) =>
      FlipShortHashesRequest(
        method: json["method"],
