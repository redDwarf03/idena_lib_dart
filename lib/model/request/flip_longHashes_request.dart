...
FlipLongHashesRequest flipLongHashesRequestFromJson(String str) =>
    FlipLongHashesRequest.fromJson(json.decode(str));

String flipLongHashesRequestToJson(FlipLongHashesRequest data) =>
...
class FlipLongHashesRequest {
  ...
  factory FlipLongHashesRequest.fromJson(Map<String, dynamic> json) =>
      FlipLongHashesRequest(
        method: json["method"],
