...
DnaCeremonyIntervalsRequest dnaCeremonyIntervalsRequestFromJson(String str) =>
    DnaCeremonyIntervalsRequest.fromJson(json.decode(str));

String dnaCeremonyIntervalsRequestToJson(DnaCeremonyIntervalsRequest data) =>
...
class DnaCeremonyIntervalsRequest {
  ...
  factory DnaCeremonyIntervalsRequest.fromJson(Map<String, dynamic> json) =>
      DnaCeremonyIntervalsRequest(
        method: json["method"],
