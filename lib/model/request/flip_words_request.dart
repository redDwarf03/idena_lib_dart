...
FlipWordsRequest flipWordsRequestFromJson(String str) =>
    FlipWordsRequest.fromJson(json.decode(str));

String flipWordsRequestToJson(FlipWordsRequest data) =>
...
class FlipWordsRequest {
  ...
  factory FlipWordsRequest.fromJson(Map<String, dynamic> json) =>
      FlipWordsRequest(
        method: json["method"],
