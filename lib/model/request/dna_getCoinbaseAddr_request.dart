...
DnaGetCoinbaseAddrRequest dnaGetCoinbaseAddrRequestFromJson(String str) =>
    DnaGetCoinbaseAddrRequest.fromJson(json.decode(str));

String dnaGetCoinbaseAddrRequestToJson(DnaGetCoinbaseAddrRequest data) =>
...
class DnaGetCoinbaseAddrRequest {
  ...
  factory DnaGetCoinbaseAddrRequest.fromJson(Map<String, dynamic> json) =>
      DnaGetCoinbaseAddrRequest(
        method: METHOD_NAME,
