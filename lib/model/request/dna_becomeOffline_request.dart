...
DnaBecomeOfflineRequest dnaBecomeOfflineRequestFromJson(String str) =>
    DnaBecomeOfflineRequest.fromJson(json.decode(str));

String dnaBecomeOfflineRequestToJson(DnaBecomeOfflineRequest data) =>
...
class DnaBecomeOfflineRequest {
  ...
  factory DnaBecomeOfflineRequest.fromJson(Map<String, dynamic> json) =>
      DnaBecomeOfflineRequest(
        method: json["method"],
