...
DnaActivateInviteRequest dnaActivateInviteRequestFromJson(String str) =>
    DnaActivateInviteRequest.fromJson(json.decode(str));

String dnaActivateInviteRequestToJson(DnaActivateInviteRequest data) =>
...
class DnaActivateInviteRequest {
  ...
  factory DnaActivateInviteRequest.fromJson(Map<String, dynamic> json) =>
      DnaActivateInviteRequest(
        method: json["method"],
