...
DnaBecomeOnlineRequest dnaBecomeOnlineRequestFromJson(String str) =>
    DnaBecomeOnlineRequest.fromJson(json.decode(str));

String dnaBecomeOnlineRequestToJson(DnaBecomeOnlineRequest data) =>
...
class DnaBecomeOnlineRequest {
  ...
  factory DnaBecomeOnlineRequest.fromJson(Map<String, dynamic> json) =>
      DnaBecomeOnlineRequest(
        method: json["method"],
