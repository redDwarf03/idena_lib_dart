...
DnaGetBalanceRequest dnaGetBalanceRequestFromJson(String str) =>
    DnaGetBalanceRequest.fromJson(json.decode(str));

String dnaGetBalanceRequestToJson(DnaGetBalanceRequest data) =>
...
class DnaGetBalanceRequest {
  ...
  factory DnaGetBalanceRequest.fromJson(Map<String, dynamic> json) =>
      DnaGetBalanceRequest(
        method: METHOD_NAME,
